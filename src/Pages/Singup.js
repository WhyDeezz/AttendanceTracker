                    ...
                    overflow: "hidden",
                            ...
                            margin: "0 16px",
                                            ...
                                            marginBottom: "16px",
                                                ...
                                                fontSize: "16px",
                                                color: isDark ? "#f3f4f6" : "#111827",
                                            } }) }), _jsx(motion.div, { initial: { opacity: 0, x: -20 }, animate: { opacity: 1, x: 0 }, transition: { delay: 0.5, duration: 0.5 }, children: _jsx("input", { type: "password", placeholder: "\u2022\u2022\u2022\u2022\u2022\u2022\u2022\u2022", value: password, onChange: (e) => setPassword(e.target.value), onFocus: () => setIsFocused(true), onBlur: () => setIsFocused(false), required: true, className: "input-field", style: {
                                                width: "100%",
                                                height: "56px",
                                                backgroundColor: isDark ? "#1f2937" : "#f9fafb",
                                                border: `2px solid ${isDark ? "#374151" : "#e5e7eb"}`,
                                                ...
                                                fontSize: "16px",
                                                color: isDark ? "#f3f4f6" : "#111827",
                                            } }) }), _jsx(motion.div, { initial: { opacity: 0, y: 20 }, animate: { opacity: 1, y: 0 }, transition: { delay: 0.6, duration: 0.5 }, children: _jsxs(motion.div, { whileHover: { scale: 1.02 }, whileTap: { scale: 0.98 }, children: [isPending && (_jsx("button", { type: "submit", disabled: true, className: "btn", style: {
                                                        width: "100%",
                                                        height: "56px",
                                                        borderRadius: "16px",
                                                        background: isDark
